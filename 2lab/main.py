...
print(
    "Total perimeter:",
    agr_perimeter(rectangles)
)

print(
    "Min area polygon:",
    agr_min_area(rectangles)
)

print(
    "Nearest point:",
    agr_origin_nearest(rectangles)
)

print(
    "Max side:",
    agr_max_side(rectangles)
)
